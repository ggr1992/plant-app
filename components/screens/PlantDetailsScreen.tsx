		...
		<View style={styles.page}>
			<SafeAreaView style={styles.containerWrapper}>
				<ScrollView contentContainerStyle={styles.container} ref={scrollRef}>
					...
					<Text style={styles.headerTextBold}>{plantDetails['scientific_name']}</Text>
					...
					{displayCareGuide && (
						<View
							...
							<View
								...
								<Text style={styles.sectionHeaderText}>{plantDetails['watering']}</Text>
							</View>
							...
							<View
								...
								<Text style={styles.sectionHeaderText}>{plantDetails['sunlight'].join(', ')}</Text>
							</View>
							...
							{plantDetails['pruning_description'] && (
								<>
									<View
										...
										<Text style={styles.sectionHeaderText}>{plantDetails['maintenance']} maintenance</Text>
									</View>
							...
							{plantDetails['soil'].length !== 0 && (
								<View
									...
									<Text style={styles.sectionHeaderText}>{plantDetails['soil'].join(', ')}</Text>
								</View>
							)}
							{plantDetails['propagation'] !== 0 && (
								<View
									...
									<Text style={styles.sectionHeaderText}>{plantDetails['propagation'].join(', ')}</Text>
								</View>
							)}
						</View>
					)}
