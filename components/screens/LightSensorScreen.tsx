...
const conditionMap = {
  ...
  10000: {
    ...
    description:
      "Very bright indoor light but still not as strong as sunlight outdoors.",
  },
  25000: {
    image: require("../../assets/light-full-sun.png"),
    name: "Full Daylight",
  ...
  999999: {
    ...
    name: "Full Sun",
    description:
      "High-light/full-sun intensity. Suitable for outdoor plants requiring a lot of light.",
  },
};
    ...
    <>
      ...
      <View style={styles.container}>
        {Platform.OS !== "android" && (
          <>
            <Image
              source={require("../../assets/light-part-shade.png")}
              style={styles.placeholderIcon}
            />
            <Text style={styles.placeholderText}>
              Sorry, this feature is currently only available for Android
              devices.
            </Text>
          </>
        )}
        {Platform.OS === "android" && (
          <View style={styles.sensor}>
            ...
            <Text style={styles.subheader}>
              Check the amount of light by moving your phone to different areas!
            </Text>
            {selectedCondition !== null && (
              <Image
                source={selectedCondition.image}
                style={styles.luxReadingImage}
              />
            )}
            <Text style={styles.luxReading}>{illuminance} lux</Text>
            <Text style={styles.conditionName}>
              {selectedCondition ? selectedCondition.name : "Scanning..."}
            </Text>
            <Text style={styles.conditionDescription}>
              {selectedCondition?.description ?? "Loading..."}
            </Text>
            <View style={styles.buttonContainer}>
              ...
              >
                <Text style={styles.buttonText}>
                  {isActive ? "Resume " : "Pause "}scanning
                </Text>
              </TouchableOpacity>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  placeholderText: { textAlign: "center", fontSize: 20 },
  header: {
    fontSize: 36,
    textAlign: "center",
    marginBottom: 10,
  ...
  luxReading: { fontSize: 24, alignSelf: "center" },
  conditionName: {
    textAlign: "center",
    fontSize: 24,
    marginTop: 20,
